      ...
      html: `
        <div style="text-align: center; padding: 4px; max-width: 100%;">
          ...
          <div style="margin-bottom: 12px;">
            <img src="${member.photo}" alt="${member.name}" style="width: 130px; height: 165px; border-radius: 12px; margin-bottom: 10px; border: 3px solid #1b5baf; box-shadow: 0 6px 20px rgba(27, 91, 175, 0.22); object-fit: cover;" />
            <h2 style="color: #1b5baf; font-weight: 700; font-size: 1.35rem; margin: 0 0 6px 0; line-height: 1.25; word-wrap: break-word;">${member.name}</h2>
          </div>
          ...
          <!-- Designation Section -->
          <div style="background: linear-gradient(135deg, #fff3e0 0%, #ffe0b2 100%); padding: 10px 12px; border-radius: 10px; margin: 10px 0; border-left: 3px solid #f57c00;">
          ...
          <div style="background: linear-gradient(135deg, #f0f4ff 0%, #f5f9ff 100%); padding: 10px 12px; border-radius: 10px; margin: 10px 0; border-left: 3px solid #2a6cc7;">
            <div style="display: flex; align-items: flex-start; gap: 10px;">
              ...
              <div style="text-align: left; width: 100%;">
                ...
                <div style="color: #2a6cc7; font-size: 0.86rem; line-height: 1.35;">${member.qualification}</div>
              </div>
            </div>
          </div>

          <!-- Contact Section -->
          <div style="display: flex; align-items: center; justify-content: center; gap: 10px; background: linear-gradient(135deg, #e3f2fd 0%, #bbdefb 100%); padding: 10px 12px; border-radius: 12px; margin-top: 10px; border-left: 4px solid #1b5baf;">
            ...
            <div style="text-align: left; width: 100%;">
              ...
              <strong style="color: #1b5baf; font-size: 1rem;">${member.contact}</strong>
            </div>
          </div>
        </div>
      `,
