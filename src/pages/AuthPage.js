          ...
          {tab === 'login' ? (
            <motion.div key="auth-login" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              <Form onSubmit={handleLogin}>
                <Form.Group style={{ marginBottom: '20px' }}>
                  <Form.Label style={{ fontWeight: 600, color: '#333', marginBottom: '8px', display: 'block', fontSize: '14px' }}>Employee ID or PBO Number</Form.Label>
                  {renderInput(<FaIdBadge />, { type: 'text', placeholder: 'Enter Employee ID or PBO Number', value: loginForm.identifier, onChange: (e) => setLoginForm({ ...loginForm, identifier: e.target.value }), required: true })}
                </Form.Group>
                <Form.Group style={{ marginBottom: '20px' }}>
            ...
            <motion.div key="auth-register" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              <Form onSubmit={handleRegister}>
                <div className="auth-page-grid">
                  ...
                  <Form.Group style={{ marginBottom: '20px' }}>
                    <Form.Label style={{ fontWeight: 600, color: '#333', marginBottom: '8px', display: 'block', fontSize: '14px' }}>PBO Number</Form.Label>
                    {renderInput(<FaIdCard />, { type: 'text', placeholder: 'Enter PBO Number', value: registerForm.pbo_number, onChange: (e) => setRegisterForm({ ...registerForm, pbo_number: e.target.value }), required: true })}
                  </Form.Group>
                  <Form.Group style={{ marginBottom: '20px' }}>
            ...
            <motion.div key="auth-forgot" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              <Form onSubmit={handleForgotPassword}>
                ...
                {renderInput(<FaIdCard />, { type: 'text', placeholder: 'PBO Number', value: forgotForm.pbo_number, onChange: (e) => setForgotForm({ ...forgotForm, pbo_number: e.target.value }), required: true })}
