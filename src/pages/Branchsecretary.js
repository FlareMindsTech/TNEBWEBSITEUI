...
const Branchsecretary = () => {
  ...
  const showSecretaryDetails = (secretary) => {
    ...
    if (secretary.contact3) {
      contactHTML += `
        <div style="display: flex; align-items: center; justify-content: center; gap: 12px; background: linear-gradient(135deg, #e8f5e9 0%, #c8e6c9 100%); padding: 14px 18px; border-radius: 12px; border-left: 4px solid #2e7d32;">
          ...
          <div style="text-align: left;">
            ...
            <strong style="color: #2e7d32; font-size: 1.1rem;">${secretary.contact3}</strong>
          </div>
        </div>
      `;
    }
